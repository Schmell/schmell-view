import { c as create_ssr_component, h as compute_rest_props, a as subscribe, i as spread, p as escape_attribute_value, j as escape_object, e as escape, b as add_attribute, g as get_store_value, q as onDestroy } from "./ssr.js";
import { F as Form$1 } from "./form.js";
import { a as cn, c as capitalizeFirstLetter } from "./index3.js";
import { d as derived, w as writable } from "./index2.js";
import { p as page } from "./stores.js";
import { t as tick } from "./scheduler.js";
import { s as splitPath, t as traversePath, m as mapErrors, e as errorShape, a as traversePathsAsync, b as traversePaths, c as setPaths, d as clone$1, f as clearErrors, i as isInvalidPath, S as SuperFormError, g as mergePath, h as comparePaths, j as flattenErrors, p as pathExists } from "./errors.js";
import * as devalue from "devalue";
import { stringify } from "devalue";
import { i as invalidateAll } from "./navigation.js";
...
const Form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["formObj", "noDebug", "action"]);
  let $message, $$unsubscribe_message;
  let $$unsubscribe_debug;
  let { formObj } = $$props;
  let { noDebug = false } = $$props;
  let { action = void 0 } = $$props;
  const { form: debug, message, enhance: enhance2 } = formObj;
  ...
  return `<form${spread(
    ...
    {}
  )}><div class="flex justify-end text-warning min-h-7"><div class="min-h-7">${$message ? `${escape($message)}` : ``}</div></div> ${slots.default ? slots.default({}) : ``} ${slots.bottomLinks ? slots.bottomLinks({}) : ``}</form> ${``}`;
});
const Label = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<label${add_attribute("for", name, 0)}${add_attribute("class", cn("p-0", className), 0)}><span>${escape(label ? label : capitalizeFirstLetter(name))}</span> <span class="text-accent">${escape("")}</span></label>`;
});
