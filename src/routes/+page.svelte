	  ...
	  <div class="modal-box">
		...
		<div class="modal-action">
		  <form method="dialog">
			...
			<a href="/organization/edit/new?from={$page.url.pathname}{$page.url.search}" class="btn btn-primary w-full">Create Organization</a>
		  </form>
		</div>
	  </div>
	</dialog>
			...
			{:else}
				{#each likes as like}
					...
					{#if like.type === 'comment'}
						...
						>
							<div class="flex justify-between  w-full pl-2 py-2 pr-4  rounded-r-xl bg-info bg-opacity-10">
